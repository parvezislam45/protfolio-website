...
const Web = () => {
  return (
    <div className="bg-black">
      <div className="mt-8">
        <h1 className="text-4xl text-center text-bold heading" id="service">
          My Service
        </h1>
      </div>
      <MyService></MyService>
      <div className="mt-8">
        <h1 className="text-4xl text-center text-bold heading" id="web">
          My WebPage
        </h1>
      </div>
        ...
        <div class="card w-96 shadow-xl transition ease-in-out delay-150 bg-black hover:-translate-y-1 hover:scale-110 hover:bg-black duration-300">
          ...
          <div class="card-body items-center text-center">
            ...
            <div className="mt-3">
              <button
                type="button"
                class="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-black duration-300"
              >
                <svg
